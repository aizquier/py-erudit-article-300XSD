...
class Article(Element):
    ...
    def __init__(self, xmlstring):
        ...
        erudit3xsd = 'http://www.erudit.org/xsd/article http://www.erudit.org/xsd/article/3.0.0/eruditarticle.xsd'
        ...
        # * /article/admin/revue
        self.populatefrom(self.admin.revue, \
